...
class AdminSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Admin::findOne(['id' => 1])->update(['account' => 'admin', 'status' => 1]);
        Admin::findOne(['id' => 2])->update(['account' => 'admin1', 'status' => 1]);
        ...
        AdminRole::create(['adminId' => 1, 'roleId' => 1]);
        AdminRole::create(['adminId' => 2, 'roleId' => 2]);
