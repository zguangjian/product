    ...
    $(document).ajaxError(
        ...
        function (event, xhr, options, exc) {
            ...
            switch (xhr.status) {
                ...
                case 404:
                    layer.msg("您访问的资源不存在。", {icon: 2, time: 2000}, function () {
                        layer.closeAll();
                    });
                    break;
                case 405:
                    layer.msg("请求方式错误！", {icon: 2, time: 2000}, function () {
                        layer.closeAll();
                    });
                    break;
                case 420:
                ...
                case 422:
                    for (let key in xhr.responseJSON.errors) {
                        layer.msg(xhr.responseJSON.errors[key].shift(), {icon: 2, time: 2000}, function () {
                            layer.closeAll();
                        })
                        return false;
                    }
